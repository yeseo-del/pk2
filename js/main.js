...
const skillBaseData = {
    "Concentration": {name: "Concentration", maxXp: 100, effect: 0.1, description: "Ability XP"},
    "Productivity": {name: "Productivity", maxXp: 100, effect: 0.1, description: "Class XP"},
    "Bargaining": {name: "Bargaining", maxXp: 100, effect: -0.1, description: "Reduced Expenses"},
    ...
    "Life Essence": {name: "Life Essence", maxXp: 100, effect: 0.1, description: "Longer Lifespan"},
    "Time Warping": {name: "Time Warping", maxXp: 100, effect: 0.1, description: "Gamespeed"},
    "Astral Body": {name: "Astral Body", maxXp: 100, effect: 0.35, description: "Longer lifespan"},
	"Temporal Dimension": {name: "Temporal Dimension", maxXp: 100, effect: 0.25, description: "Gamespeed"},
	"All Seeing Eye": {name: "All Seeing Eye", maxXp: 100, effect: 0.27, description: "T.A.A Pay"},
	"Brainwashing": {name: "Brainwashing", maxXp: 100, effect: -0.1, description: "Reduced Expenses"},
	
	"Absolute Wish": {name: "Absolute Wish", maxXp: 100, effect: 0.5, description: "Evil Gain"},
    "Void Amplification": {name: "Void Amplification", maxXp: 100, effect: 0.1, description: "The Void XP"},
    "Mind Seize": {name: "Mind Seize", maxXp: 100, effect: 0.6, description: "Reduced Happiness"},
	"Ceaseless Abyss": {name: "Ceaseless Abyss", maxXp: 100, effect: 0.585, description: "Longer Lifespan"},
	"Void Symbiosis": {name: "Void Symbiosis", maxXp: 100, effect: 0.15, description: "Ability XP"},
    "Void Embodiment": {name: "Void Embodiment", maxXp: 100, effect: 0.25, description: "Evil Gain"},
	"Abyss Manipulation": {name: "Abyss Manipulation", maxXp: 100, effect: -0.1, description: "Reduced Expenses"},
	
	
	"Cosmic Longevity": {name: "Cosmic Longevity", maxXp: 100, effect: 0.15, description: "Longer Lifespan"},
    "Cosmic Recollection": {name: "Cosmic Recollection", maxXp: 100, effect: 0.65, description: "Max Lvl Multiplier"},
	"Essence Collector": {name: "Essence Collector", maxXp: 100, effect: 0.1, description: "Essence Gain"},
	"Galactic Command": {name: "Galactic Command", maxXp: 100, effect: -0.1, description: "Reduced Expenses"},
    ...
    "Demon's Wealth": {name: "Demon's Wealth", maxXp: 100, effect: 0.2, description: "Class Pay"},
	"Dark Knowledge": {name: "Dark Knowledge", maxXp: 100, effect: 0.3, description: "Class XP"},
	"Void Influence": {name: "Void Influence", maxXp: 100, effect: 0.28, description: "All XP"},
	"Time Loop": {name: "Time Loop", maxXp: 100, effect: 0.001, description: "Gamespeed"},
	"Evil Incarnate": {name: "Evil Incarnate", maxXp: 100, effect: 0.4, description: "Ability XP"},
	

    "Yin Yang": {name: "Yin Yang", maxXp: 100, effect: 0.2, description: "Essence + Evil Gain"},
	"Parallel Universe": {name: "Parallel Universe", maxXp: 100, effect: 0.2, description: "All XP"},
	"Higher Dimensions": {name: "Higher Dimensions", maxXp: 100, effect: 0.1, description: "Longer Lifespan"},
	"Epiphany": {name: "Epiphany", maxXp: 100, effect: 0.12, description: "Galactic Council XP"},
